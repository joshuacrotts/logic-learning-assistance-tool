...
public class UIDescriptionObject implements GsonInterface {
    ...
    private Turnstil turnstil;
    private DoubleTurnstile doubleTurnstile;
    private Universal universal;
    private Existential existential;

    public UIDescriptionObject(Implication implication, Equivalence equivalence, Negation negation, Conjunction conjunction, Disjunction disjunction, ExclusiveDisjunction exclusiveDisjunction, Turnstil turnstil, DoubleTurnstile doubleTurnstile, Universal universal, Existential existential) {
    ...
    public Turnstil getTurnstil() {
        return turnstil;
    }

    public void setTurnstil(Turnstil turnstil) {
        this.turnstil = turnstil;
    }
