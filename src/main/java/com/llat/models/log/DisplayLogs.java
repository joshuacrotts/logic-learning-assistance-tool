...
public class DisplayLogs {
    ...
    public static void warning(String _message) {
        System.out.println(ConsoleColors.YELLOW + "[WARNING]" + " - " + ConsoleColors.RESET + _message);
    }

    public static void state(String _stateMessage) {
        System.out.println(ConsoleColors.PURPLE + "[State]" + " - " + ConsoleColors.RESET + _stateMessage);
    }
    ...
    public static void note(String _stateMessage) {
        System.out.println(ConsoleColors.CYAN + "[Note]" + " - " + ConsoleColors.RESET + _stateMessage);
    }

    public static void note(String _stateMessage, Boolean isSub) {
        if (isSub) {
            System.out.println("\t" + ConsoleColors.CYAN + "[Note]" + " - " + ConsoleColors.RESET + _stateMessage);
        } else {
            note(_stateMessage);
