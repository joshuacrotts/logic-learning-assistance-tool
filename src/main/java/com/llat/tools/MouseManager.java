...
public class MouseManager {
    ...
    public double getCurX () { return this.curX; }

    public double getCurY () { return this.curY; }

    public void setCurX (double _curX) { this.curX = _curX; }

    public void setCurY (double _curY) { this.curY = _curY; }
