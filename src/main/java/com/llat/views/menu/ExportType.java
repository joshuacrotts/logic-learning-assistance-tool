...
public enum ExportType {
    ...
    LATEX_PARSE_TREE("Latex Parse Tree", ".tex", new FileChooser.ExtensionFilter("LaTeX files (*.tex)", "*.tex")),
    ...
    PDF_PARSE_TREE("PDF Parse Tree", ".pdf", new FileChooser.ExtensionFilter("PDF files (*.pdf)", "*.pdf")),
