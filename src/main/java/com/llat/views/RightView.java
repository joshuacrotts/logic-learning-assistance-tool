...
public class RightView {
    ...
    public RightView(Controller _controller) {
        ...
        this.axiomsTab = new Tab(controller.getUiObject().getMainView().getMainViewLabels().getAxiomTabLabel(), this.rulesAxiomsView.getParentPane());
        this.axiomsTab.setClosable(false);
        // Setting Tab historyTab properties.
        this.historyTab = new Tab(controller.getUiObject().getMainView().getMainViewLabels().getHistoryTabLabel(), this.historyView.getParentPane());
